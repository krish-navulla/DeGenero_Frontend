...
const Form = () => {
    ...
    <div  id="contact" className="min-h-screen w-screen">
        <div className="relative mb-8 mt-36 flex flex-col items-center gap-5">
            ...
            <AnimatedTitle title= "<b>G</b>et in Touch"
            containerClass="mt-5 !text-black text-center"/>


<div className="about-subtext flex flex-col items-center text-center gap-4">
  <img src="/img/logo.png" alt="logo" className="w-20" />
  <p className="text-lg font-bold">De Genero</p>
  <p className="text-sm text-gray-600">
    The Powerful Tool for Comprehensive and Transparent Social Impact Reporting
  </p>
</div>
